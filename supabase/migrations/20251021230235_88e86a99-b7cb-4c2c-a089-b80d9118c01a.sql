-- Оновлюємо функцію для врахування українського часового поясу при форматуванні дати і часу
...
BEGIN
  ...
  -- Форматуємо дату та час у часовому поясі України (Europe/Kiev в PostgreSQL)
  v_scheduled_at := NEW.scheduled_at AT TIME ZONE 'Europe/Kiev';
  ...
  v_appointment_link := 'https://nfwqjkbpvfmvpxvzkbnt.lovable.app/appointment/' || NEW.id;
  ...
  LOOP
    ...
    v_message_body := replace(v_message_body, '{appointment_link}', v_appointment_link);
